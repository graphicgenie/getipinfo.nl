...
import Logo from '@/Components/LogoColor.vue'
...
const navigation = [
    ...
    { name: 'Account', href: route('account'), icon: UsersIcon, current: false },
    { name: 'API Tokens', href: route('api-tokens.index'), icon: FolderIcon, current: false },
    // { name: 'Security', href: route('security'), icon: DocumentDuplicateIcon, current: false },
]
                        ...
                        <Menu as="div" class="relative">
                            <MenuButton class="-m-1.5 flex items-center p-1.5">
                                ...
                                <span class="hidden lg:flex lg:items-center">
                                    <span class="ml-4 text-sm font-semibold leading-6 text-gray-500" aria-hidden="true">{{ $page.props.auth.user.name }}</span>
